...
public class Utente implements Runnable {
    ...
    private final Lock lockprof;
    private final Condition waitprof;
    private int indice;

    public Utente(Ruolo ruolo, Lock lock, Condition occupato, Lock lockprof, Condition waitprof) {
        this.ruolo = ruolo;
        this.lock = lock;
        this.occupato = occupato;
        this.lockprof = lockprof;
        this.waitprof = waitprof;
    }

    public Utente(Ruolo ruolo, Lock lock, Condition occupato, Lock lockprof, Condition waitprof, int indice) { //costruttore per i tesisti che necessitano di un particolare computer
        this(ruolo, lock, occupato, lockprof, waitprof);
        this.indice = indice;
    }
